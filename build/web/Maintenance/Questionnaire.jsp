<%-- 
    ...
    Created on : Aug 23, 2013, 7:42:24 AM
    Author     : Maureen
--%>
...
<div class="example">
    ...
    <%@include file="../menu/adminmenu.html" %>
		<div id="container">
			...
			<div id="demo">
  <button id="btnAddNewRow" value="Ok">Add new question...</button> 
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
   ...
   <tbody>
        ...
        <c:forEach  var="today" items="${list3}"  >
          ...
          <c:set var="MID"  value="${today.QSTN}"></c:set>
           
        <td> <input type="hidden" id="Mid" name="id" value="<%= pageContext.getAttribute("ID")%>" /></td>
        <td> <input type="hidden" id="Mid1" name="QSTN" value="<%= pageContext.getAttribute("QSTN")%>" /></td>
         
            <tr id="<%=pageContext.getAttribute("ID")%>">
           
           <td>  ${today.ID} </td>
           <td class="sorting_1">${today.QSTN} </td>
