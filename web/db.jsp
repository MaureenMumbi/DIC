        ...
        <div id="container" style="height:620px;background:orange;">
            ...
            <div id="header" style="margin-left:170px ;">
                <div class="ui-widget" style="width:1160px;" >
                    <div style="padding: 0 .7em; background-color: red;">
            ...
            <div id="content" style="height:500px;margin-left:250px; overflow:hidden ;">
                ...
                <form action="updatedbpword" method="post" style="margin-left: 200px; height:100%x; width:540px; background-color: lightsteelblue;">
                    ...
                    <table style="margin-left:120px;width:300px;"   cellpadding="8px" cellspacing="6px">
                        ...
                        <tr> <td style="text-align: right;">Database : <img src="images/blguide.png" title="enter the database name e.g DIC"/></td>
                            <td style="text-align: right;"><input id="database"  type=text required name=database value="dic" placeholder="e.g dic"  class="textbox"/></td>
                        </tr>
            ...
            <div id="footer" style="background: orange;">
                ...
                %>
                <p align="center"> &copy <a href="#" title="">DIC</a> Aphia Plus | USAID <%=year%></p>
            </div>
        </div>
    </body>
