<%-- 
    Document   : viewservicetracker
    Created on : Aug 26, 2015, 10:11:39 AM
    Author     : Maureen
--%>
...
String task="Accessed module for viewing servicr tracker. ";
...
<!--    <form name="form">
        -->
         ...
         <br/>
         <h3 style="text-align: center; background-color: orange;"> SERVICE TRACKER  </h3>
...
String getaccesstrials="select * from servicetracker ";
...
<tr>
    ...
    <td><%= conn.rs2.getString("RegisteredDIC") %></td> 
    <td><%= conn.rs2.getString("visitedDIC") %></td> 
    <td><%= conn.rs2.getString("RiskAssessment") %></td> 
    <td><%= conn.rs2.getString("RiskReduction") %></td> 
    <td><%= conn.rs2.getString("Date") %></td> 
