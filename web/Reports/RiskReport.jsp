<%-- 
    Document   : RiskReport
    Created on : May 19, 2014, 3:18:56 PM
    Author     : Maureen
--%>
 ...
 months.hidden = true; 
  ...
  Quarter.required = true;
    ...
    <body onload="disabler();">
        ...
        <div class="example" style="width: 1000px; height: 700px;">
