<%-- 
    Document   : RawData
    Created on : Nov 2, 2014, 4:08:08 PM
    Author     : Maureen
--%>
...
String task="Accessed Raw data reports ";
...
%>
    ...
    <td>
        ...
        <form method="post" action="/DIC/RawData">
                ...
                <tr class="d0">
                    ...
                    <td> <select name="type" style="height: 30px;" required="true">
                      <option value=""> </option>
                            ...
                            <option value="riskreductions"> Risk Reductions</option>
