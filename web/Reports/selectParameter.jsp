...
String task="Accessed services provided reports ";
...
%>
    ...
    <h3></h3>
        ...
        <form method="post" action="/DIC/SessionStore">
        <table>
                ...
                <tr class="d1">
                    ...
                    <td>
                        <select name="parameter" id="parameter" onchange="return select_parameter();" required="true">
                            ...
                            <option value="Condoms">Condoms Provided </option>
                            <option value="WaterBased">WBL Provided </option>
