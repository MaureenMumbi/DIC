<%-- 
    Document   : backup
    Created on : Mar 26, 2014, 8:22:23 AM
    Author     : AphiaPlus
--%>
...
String task="Accessed Back up module. ";
        ...
        <!--=====================================================================================--> 
          ...
          <div style="clear:both" style="padding-top: 50px;">
                ...
                session.removeAttribute("network_error");
                        ...
                        %>     
                <form  action="BackupSQL" style="margin-left: 200px; margin-right: 100px;margin-top: 100px; height: 110px; width: 700px; background-color: #F5F5F5;">
