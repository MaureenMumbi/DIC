 ...
 * @author SIXTYFOURBIT
 */
public class editfingerprint extends HttpServlet {
...
Fingerprintstring= Capture.Run(m_reader, false,uniqueid);
             
                         
   
session.setAttribute("kidole",Fingerprintstring);
	...
	//MessageBox.Warning("Fingerprint Reader device not Detected. Ensure it is inserted on a functioning USB port");
      ...
      //  System.out.println("is scanner called already? == "+scannercalled);
         ...
         if(detailssaved==true){
             ...
             Responsetext="<img src=\"images/present.png\"/><font color=\"orange\"> "+uniqueid+"s fingerprint capture succesfully</font>";
