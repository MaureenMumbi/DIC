	...
	implements ActionListener
{
	...
	private boolean       m_bStreaming;
        public static String Fingerprintstr="";
        
        private int generalcounter=0;
	
	private Capture(Reader reader, boolean bStreaming,String uniqueid){
		m_reader = reader;
...
//		}
			...
			if(null != evt.capture_result){
               ...
               //save to the database..
                         ...
                         Fingerprintstr=bytesToHexString1(fb);
                       
                 
                   // boolean dbsaved = savetodb1(chwidentity, bytesToHexString1(fb));
...
//=============================================METHOD TO SAVE CONTENTS TO THE DATABASE=====================================           
	...
	public static String Run(Reader reader, boolean bStreaming,String uniqueid){
    	JDialog dlg = new JDialog((JDialog)null, "Update Fingerprint", true);
    	Capture capture = new Capture(reader, bStreaming,uniqueid);
    	capture.doModal(dlg);
        //======
