...
public class CaptureThread extends Thread 
{
	...
	public class CaptureEvent extends ActionEvent{
		...
		public CaptureEvent(Object source, String action, Reader.CaptureResult cr, Reader.Status st, UareUException ex){
			...
			reader_status = st;
			exception = ex;
                        System.out.println("INSIDE CAPTURE EVENT Constructor");
	...
	public CaptureThread(Reader reader, boolean bStream, Fid.Format img_format, Reader.ImageProcessing img_proc){
		...
		m_proc = img_proc;
               ...
               //   System.out.println("INSIDE CAPTURE THREAD Constructor");
                 // System.out.println("Received PARAMETERS::Reader "+reader+"  \nImg_format "+img_format);
	...
	private void Capture(){
		try{
			...
			while(!bReady && !m_bCancel){
                              System.out.println("Reader is busy. Thread is sleeping for 100 milliseconds ");
	...
	public void run(){
		if(m_bStream){
			Stream();
                     ...
                     System.out.println("CAPTURE THREAD CALLED");
