...
public class EditSMS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
          ...
          if(request.getParameter("sms_"+counters)!=null && !request.getParameter("sms_"+counters).equals("")){
           sms=request.getParameter("sms_"+counters); } 
          if(request.getParameter("id_"+counters)!=null && !request.getParameter("id_"+counters).equals("")){
           id=request.getParameter("id_"+counters); } 
          
          String update="update messages set message='"+sms+"' where msgid='"+id+"'";
