 ...
 * @author SIXTYFOURBIT
 */
public class copytemplates_1 extends HttpServlet {
...
//CREATE A PATH IN THE COMPUTER FOR STORING TEXT FILES
    ...
    String sourcepath = getServletContext().getRealPath("/EnrolledTemplate.xlsm");
    String sourcepath1 = getServletContext().getRealPath("/ServedTemplate.xlsm");
        String mydrive = sourcepath.substring(0, 1);
        //dbconnpath=mydrive+":\\MNHC_SYSTEM_APHIA_PLUS\\"; 
      dbconnpath=mydrive+":\\DIC_DBBACKUP\\MACROS\\"; 
...
String destpath=dbconnpath+"\\EnrolledTemplate.xlsm";
String destpath1=dbconnpath+"\\ServedTemplate.xlsm";
...
public void transfermacros(String src1,String desteepath ){
        ...
        //=======================================================================
            ...
            Logger.getLogger(copytemplates_1.class.getName()).log(Level.SEVERE, null, ex);
        }
