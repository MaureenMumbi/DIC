 ...
 * @author Maureen
 */
public class rrinsert extends HttpServlet {
...
String query2="REPLACE INTO riskreductions2(Cadre,RiskRedID,UniqueIDs1,Date,districts1,dicnames1,CasualCdUse, CdProvided,  RegCdUse, RegCdAction,"
...
//        + "("+riskassessid+"),"
//        + "("+DOA+"),"
  + "(SELECT riskreductionmain.RiskReductionID FROM riskreductiondetails,riskreductionmain WHERE  riskreductionmain.RiskReductionID = '"+riskassessid+"' limit 1),"
  ...
  + "(SELECT Appointments FROM riskreductiondetails,riskreductionmain WHERE QID = 'D1' AND riskreductiondetails.RiskReductionID = '"+riskassessid+"' limit 1),"
  + "(SELECT Action FROM riskreductiondetails,riskreductionmain WHERE QID = 'D2' AND riskreductiondetails.RiskReductionID = '"+riskassessid+"' limit 1),"
  ...
  + "(SELECT Action FROM riskreductiondetails,riskreductionmain WHERE QID = 'F1' AND riskreductiondetails.RiskReductionID = '"+riskassessid+"' limit 1),"
  ...
  + "(SELECT Action FROM riskreductiondetails,riskreductionmain WHERE QID = 'F2' AND riskreductiondetails.RiskReductionID = '"+riskassessid+"' limit 1),"
  ...
  + "(SELECT Appointments FROM riskreductiondetails,riskreductionmain WHERE QID = 'G2' AND riskreductiondetails.RiskReductionID = '"+riskassessid+"' limit 1),"
  ...
  + "(SELECT Appointments FROM riskreductiondetails,riskreductionmain WHERE QID = 'H2' AND riskreductiondetails.RiskReductionID = '"+riskassessid+"' limit 1),"
