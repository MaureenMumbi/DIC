 ...
 * @author Maureen
 */
public class RiskReductionReports extends HttpServlet {
     ...
     */
    HttpSession session;
String county_name,county_id,dic_name,dic_id,quarter_id,excel_quarter,report_type,excel_month,month_id,report_year;
String period [],county [],year_quarter [],year_months[];
...
stylex.setFont(font);
   ...
   HSSFCell cell08 = rw0.createCell(2);    
             cell08.setCellValue("SERVICES PROVIDED");
   ...
   HSSFCell cell02 = rw2.createCell(2);    
             cell02.setCellValue("Number of condoms provided");
             cell02.setCellStyle(stylex_risk);
             HSSFCell cell03 = rw3.createCell(2);    
             cell03.setCellValue("No of water based lubricants");
             cell03.setCellStyle(stylex_risk);
             HSSFCell cell04 = rw4.createCell(2);    
             cell04.setCellValue("No of audit scores ");
             cell04.setCellStyle(stylex_risk);
             HSSFCell cell05 = rw5.createCell(2);    
             cell05.setCellValue("Number provided with Health Education");
             cell05.setCellStyle(stylex_risk);
             HSSFCell cell06 = rw6.createCell(2);    
             cell06.setCellValue("Number provided with HIV testing ");
             cell06.setCellStyle(stylex_risk);
             HSSFCell cell07 = rw7.createCell(2);    
             cell07.setCellValue("Number provided with HIV testing with partner");
             cell07.setCellStyle(stylex_risk);
             HSSFCell cell23 = rw10.createCell(2);    
             cell23.setCellValue("Number provided with STI Checkup");
             cell23.setCellStyle(stylex_risk);
             HSSFCell cell21 = rw10.createCell(2);    
             cell21.setCellValue("Number provided with Cervical Cancer Screening ");
             cell21.setCellStyle(stylex_risk);
             HSSFCell cell25 = rw10.createCell(2);    
             cell25.setCellValue("Number provided with tuberculosis screening");
             cell25.setCellStyle(stylex_risk);
             HSSFCell cell26 = rw10.createCell(2);    
             cell26.setCellValue("Number provided with referal for Gender Based Violence");
             cell26.setCellStyle(stylex_risk);
             HSSFCell cell27 = rw10.createCell(2);    
             cell27.setCellValue("Number currently on FP Methods");
             cell27.setCellStyle(stylex_risk);
             HSSFCell cell28 = rw10.createCell(2);    
             cell28.setCellValue("Number provided with FP Methods");
             cell28.setCellStyle(stylex_risk);
             HSSFCell cell29 = rw10.createCell(2);    
             cell29.setCellValue("Number Linked to IGA Group");
             cell29.setCellStyle(stylex_risk);
           // autoSizeColumn(int 2, boolean useMergedCells);
//             HSSFCell cell08 = rw1.createCell(2);    
//             cell08.setCellValue(""); 
//             HSSFCell cell09 = rw1.createCell(2);    
//             cell09.setCellValue(""); 
        String county_selector="SELECT * FROM districts";
        conn.rs=conn.state.executeQuery(county_selector);
        while(conn.rs.next()){
          county_name=conn.rs.getString(2);
            
            String dic_selector="SELECT * FROM dicname WHERE DistrictID='"+conn.rs.getString(1)+"'";
        ...
        + "where RiskReductionMain.riskreductionid = RiskReductionDetails.riskreductionid "
          ...
          + "AND RiskReductionDetails.action LIKE '%Condoms were provided_%' AND Enrollment.DICName='"+dic_name+"' AND RiskReductionMain.qtr='"+quarter_id+"' AND RiskReductionMain.year='"+report_year+"' ";
...
//             conn.rs2=conn.state2.executeQuery(dom1);
 ...
 conn.rs2= conn.state2.executeQuery(query1);
          ...
          + "AND RiskReductionDetails.action LIKE 'WBL Provided_%' AND Enrollment.DICName ='"+dic_name+"' AND RiskReductionMain.qtr='"+quarter_id+"' AND RiskReductionMain.qtr='"+quarter_id+"' AND RiskReductionMain.year='"+report_year+"'";
...
outStream.flush();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RiskReductionReports.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
