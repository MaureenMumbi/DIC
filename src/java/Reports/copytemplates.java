...
//CREATE A PATH IN THE COMPUTER FOR STORING TEXT FILES
    ...
    String sourcepath = getServletContext().getRealPath("/EnrollmentQtrWard.xlsm");
    String sourcepath1 = getServletContext().getRealPath("/DatimServed.xlsm");
...
String destpath=dbconnpath+"\\EnrollmentQtrWard.xlsm";
String destpath1=dbconnpath+"\\DatimServed.xlsm";
