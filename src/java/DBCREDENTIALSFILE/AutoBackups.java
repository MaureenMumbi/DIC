...
//             }
      ...
      if (f3.exists() && f3.isDirectory()) {
          path =current_drive + ":\\DIC_DBBACKUP\\DATA\\MANUAL_BACKUP";
          new File(path).mkdirs();
          dbpath = path + "\\DIC_DATA_AS_AT_" + full_date + ".sql";
...
//           executeCmd = current_drive + ":\\Program Files\\MySQL\\MySQL Server 5.5\\bin\\mysqldump --host=eu-cdbr-azure-west-c.cloudapp.net --port=3306 --user=" + dbuser + " --password=" + dbpassword + " " + dbname + " -r " + dbpath + "";audit enrollment childage clientmember clientoccupation clientoparea medical_form
           executeCmd = current_drive + ":\\Program Files\\MySQL\\MySQL Server 5.5\\bin\\mysqldump --host=eu-cdbr-azure-west-c.cloudapp.net --port=3306 --user=" + dbuser + " --password=" + dbpassword + " " + dbname + " riskassessmentdetails riskassessmentmain riskreductionmain riskreductiondetails  -r " + dbpath + "";
