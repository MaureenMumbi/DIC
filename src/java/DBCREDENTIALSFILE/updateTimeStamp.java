...
public class updateTimeStamp extends HttpServlet {
   ...
   String AuditID,UniqueID,DrnkAlc,AlchHav,DrnkOcc,StpDrnk,FailDrnk,RemHap,NeedAlc,GuiltDrnk,InjureDrnk,FriendDrnk,DrnkAlctxt,AlcHavtxt,DrnkOcctxt,StpDrnktxt,FailDrnktxt,RemHaptxt,NeedAlctxt,GuiltDrnktxt,InjureDrnktxt,FriendDrnktxt,FinalAudit;
    String UniqueIDs,ClientInit,DOE,District,DICName,DOB,Sex,Age,MaritalStatus,Children,ChildNo,Religion,EducationLevel,PhoneNo,Residence,OperationArea,Occupation,MemberOfID,DICLearn,Email,PhoneNo1,Venue,AgeID,FirstName,SecondName,LastName,venueOther,DicLearnOther,timestamp1="";
...
//  EducationLevel=PhoneNo=Residence=OperationArea=Occupation=MemberOfID=DICLearn=Email=PhoneNo1=Venue=AgeID=FirstName=SecondName=LastName=venueOther=DicLearnOther=timestamp1=""; 
//    
//        
...
//        entrydate=conn.rs.getString(30); 
//  
// String check_if_exist="SELECT * FROM enrollment where UniqueID='"+UniqueIDs+"' and  OperationArea='"+OperationArea+"'"
...
// if(conn1.rs3.next()==true){
//     already_added=1; 
// String inserter="UPDATE dic.enrollment set entrydate='"+entrydate+"' where  UniqueID='"+UniqueIDs+"' and ClientInit='"+ClientInit+"' and DOE='"+DOE+"' and District='"+District+"' and DICName='"+DICName+"' and  AgeID='"+AgeID+"' AND Religion='"+Religion+"' AND EducationLevel='"+EducationLevel+"'AND PhoneNo='"+PhoneNo+"' AND MemberOfID='"+MemberOfID+"'";
//           System.out.println("_"+inserter+"\n");   
...
// }
// else {
////  String inserter="REPLACE INTO enrollment(UniqueID,ClientInit,DOE,District,DICName,DOB,Sex,Age,MaritalStatus,Children,ChildNo,Religion,EducationLevel,PhoneNo,Residence,OperationArea,Occupation,MemberOfID,DICLearn,Email,PhoneNo1,Venue,AgeID,FirstName,SecondName,LastName,venueOther,DicLearnOther, newdata)"
////          + "VALUES('"+UniqueIDs+"','"+ClientInit+"','"+DOE+"','"+District+"','"+DICName+"','"+DOB+"','"+Sex+"','"+Age+"','"+MaritalStatus+"','"+Children+"','"+ChildNo+"','"+Religion+"','"+EducationLevel+"','"+PhoneNo+"','"+Residence+"','"+OperationArea+"',"
////          + "'"+Occupation+"','"+MemberOfID+"','"+DICLearn+"','"+Email+"','"+PhoneNo1+"','"+Venue+"','"+AgeID+"','"+FirstName+"','"+SecondName+"','"+LastName+"','"+venueOther+"','"+DicLearnOther+"','new data')"   ;
////  
////  System.out.println("_"+inserter+"\n");
////  numberofqueries++;
////  conn1.state2.executeUpdate(inserter);  
...
//   String inserter="update childage set entrydate='"+timestamp2+"' where ChildID='"+ChildID+"' and UniqueID='"+UniqueID2+"' and AgeBrackets='"+AgeBrackets+"' and NoChild='"+NoChild+"'";
//        
//  System.out.println("_"+inserter+"\n");
//  numberofqueries++;
...
// conn1.rs3=conn1.state1.executeQuery(check_if_exist);
// if(conn1.rs3.next()==true){already_added=1; 
// String inserter="update clientoccupation set entrydate ='"+timestamp4+"' where CoccID='"+CoccID+"' and UniqueID='"+UniqueID4+"' and OccupationID='"+OccupationID+"'";
//          
//  
//  System.out.println("_"+inserter+"\n");
//  numberofqueries++;
...
// conn1.rs3=conn1.state1.executeQuery(check_if_exist);
// if(conn1.rs3.next()==true){already_added=1; 
//  String inserter="update  clientoparea set entrydate='"+timestamp5+"' where COPID='"+COPID+"' and UniqueID='"+UniqueID5+"' and AreaOpID='"+AreaOpID+"'";
//  conn1.state4.executeUpdate(inserter);  
//  
//  System.out.println("_"+inserter+"\n");
// existingdata++;
...
// if(conn1.rs3.next()==true){
//     already_added=1; 
// String inserter="update medical_form  set entrydate='"+timestamp6+"' where unique_identifier='"+unique_identifier+"'";
//       
//  System.out.println("_"+inserter+"\n");
//  numberofqueries++;
//  conn1.state2.executeUpdate(inserter);  
...
// }
// else {
////  String inserter="update medical_form  set entrydate='"+timestamp+"' where unique_identifier='"+unique_identifier+"'";
////       
////  System.out.println("_"+inserter+"\n");
////  numberofqueries++;
////  conn1.state2.executeUpdate(inserter);  
...
//         entrydate=conn.rs2.getString("timestamp");
//    
//      
//       
...
// conn1.rs3=conn1.state1.executeQuery(check_if_exist);
// if(conn1.rs3.next()==true){already_added=1; 
// String inserter="update riskreductiondetails set entrydate ='"+entrydate+"' where RiskReductionID='"+RiskReductionID+"' AND QID='"+QID+"' AND currentStatus='"+currentStatus+"' AND Action='"+Action+"' AND Appointments='"+Appointments+"'";
//  
//  System.out.println("_"+inserter+"\n");
//  numberofqueries++;
//  conn1.state4.executeUpdate(inserter);
...
// }
// else {
////  String inserter="update riskreductiondetails set entrydate '"+entrydate+"'";
//  
////  System.out.println("_"+inserter+"\n");
//  numberofqueries++;
////  conn1.state4.executeUpdate(inserter);  
...
// if(conn1.rs3.next()==true){
//     already_added=1; 
//  String inserter="UPDATE  riskassessmentmain SET entrydate='"+timestamp4+"' where AssessmentID='"+AssessID+"' and AssessmentDate='"+AssessmentDate+"' and UniqueID='"+UniqueID6+"'";
//     conn1.state4.executeUpdate(inserter);  
//       System.out.println("_"+inserter+"\n");
////  System.out.println("Clerk Data already added");
// existingdata++;
// }
// else {
////  String inserter="REPLACE INTO riskassessmentmain(AssessmentID,AssessmentDate,UniqueID)"
////          + "VALUES('"+AssessID+"','"+AssessmentDate+"','"+UniqueID6+"')";
////  
////  System.out.println("_"+inserter+"\n");
////  numberofqueries++;
////  conn1.state4.executeUpdate(inserter);  
...
while(conn.rs2.next()){
 ...
 conn1.rs3=conn1.state1.executeQuery(check_if_exist);
 if(conn1.rs3.next()==true){already_added=1; 
  String inserter="update riskreductionmain set entrydate='"+timestamp+"' where RiskReductionID='"+RiskRedID+"' and DOA='"+DOA+"' and CadreProvider='"+CadreProvider+"' and UniqueID='"+UniqueID7+"'";
...
//  String inserter="REPLACE INTO riskreductionmain(RiskReductionID,DOA,CadreProvider,UniqueID)"
//          + "VALUES('"+RiskRedID+"','"+DOA+"','"+CadreProvider+"','"+UniqueID7+"')";
//  
//  System.out.println("_"+inserter+"\n");
//  numberofqueries++;
//  conn1.state4.executeUpdate(inserter);  
...
//         timestamp11=conn.rs2.getString("timestamp");
//        
//      
//       
...
// conn1.rs3=conn1.state1.executeQuery(check_if_exist);
// if(conn1.rs3.next()==true){already_added=1; 
//  String inserter="update taskauditor set entrydate='"+timestamp11+"' where  host_comp='"+hostcomp+"' and action='"+action.replace("'", " ")+"' and  time='"+time+"' and username='"+username+"'";
//       
//  
//  System.out.println("_"+inserter+"\n");
//  numberofqueries++;
...
//         timestamp12=conn.rs2.getString("timestamp");
//        
//      
//       
...
//// existingdata++;
// 
//  String inserter="update user set entrydate ='"+timestamp12 +"' where Name='"+Name+"' and Username='"+Username+"' and Password='"+Password+"' and PhoneNo='"+PhoneNos+"'";
//  
//  System.out.println("_"+inserter+"\n");
//  numberofqueries++;
//  conn1.state4.executeUpdate(inserter);  
// }
// else {
////  String inserter="REPLACE INTO user(Name,Username,Password,PhoneNo,Email,Location,AccessLevel)"
////          + "VALUES('"+Name+"','"+Username+"','"+Password+"','"+PhoneNos+"','"+Email+"','"+Location+"','"+AccessLevel+"')";
////  
////  System.out.println("_"+inserter+"\n");
////  numberofqueries++;
////  conn1.state4.executeUpdate(inserter);  
...
// if(conn1.rs3.next()==true){
//     already_added=1; 
//  String inserter="update  riskassessmentdetails  set entrydate='"+timestamp4+"'where  AssessmentID='"+AssessmentID+"' and "
//          + "QuestionID='"+QuestionsID+"' and DirectAnswers='"+DirectAnswers+"' and CodedAnswers='"+CodedAnswers+"'";
//        
//  
//  System.out.println("_"+inserter+"\n");
//  
