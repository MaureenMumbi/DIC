...
public class importSQLData extends HttpServlet {
  ...
  private static final long serialVersionUID = 1L;
    ...
    private static final String DATA_DIRECTORY = "DICDATA";
...
//executeCmd1 = new String[]{current_drive+":\\wamp\\mysql\\bin\\mysql", "--user=" + dbuser, "--password=" + dbpassword, dbname,"-e", " source "+filePath};  
executeCmd1 = new String[]{current_drive+":\\wamp\\mysql\\bin\\mysql","--host="+localhostsplit[0], "--port="+localhostsplit[1], "--user=" + dbuser, "--password=" + dbpassword, dbname,"-e", " source "+filePath};  
...
found_folder="it is old wamp";
  ...
  for(int i=0;i<executeCmd1.length;i++){           
 System.out.println(executeCmd1[i]);            
  }
...
System.out.println("process started");
            ...
            if (processComplete == 0) {
                ...
                System.out.println("Could not import datavbvb");
    ...
    response.sendRedirect("concatenateData");
            ...
            Logger.getLogger(importSQLData.class.getName()).log(Level.SEVERE, null, ex);
        } 
