 ...
 * @author Maureen
 */
public class MaritalServlet extends HttpServlet {
...
session = request.getSession(true);
        ...
        if(list3!=null && list3.size()>0 ){list3.clear();}

                                        while(conn.rs.next())
                                        {
                                                
                                         
                       MaritalBean DB= new MaritalBean();
                       DB.setID(conn.rs.getInt(1));
                       DB.setMSTATUS(conn.rs.getString(2));
       ...
       session.setAttribute("list3", list3);
                                 String nextJSP = "/Maintenance/MaritalStatus.jsp";
