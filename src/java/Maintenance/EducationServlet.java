...
session = request.getSession(true);
                                        ...
                                        String query = "select * from educationlevel";
        ...
        if(list5!=null && list5.size()>0 ){list5.clear();}

                                        while(conn.rs.next())
                                        {
                                                
                                         
                      EducationBean DB= new EducationBean();
                       DB.setID(conn.rs.getInt(1));
                       DB.setEDUCATION(conn.rs.getString(2));
       ...
       session.setAttribute("list5", list5);
                                 String nextJSP = "/Maintenance/EducationLevel.jsp";
