...
session = request.getSession(true);
                                        ...
                                        String query = "select * from operationarea";
        ...
        if(list6!=null && list6.size()>0 ){list6.clear();}

                                        while(conn.rs.next())
                                        {
                                                
                                         
                      OperationBean DB= new OperationBean();
                       DB.setID(conn.rs.getInt(1));
                       DB.setOPAREA(conn.rs.getString(2));
       ...
       session.setAttribute("list6", list6);
                                 String nextJSP = "/Maintenance/OperationArea.jsp";
