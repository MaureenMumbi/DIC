 ...
 * @author Maureen
 */
public class UpdateKnowledge extends HttpServlet {
...
//  String unique=(String)session.getAttribute("countyid");
	...
	String query = "update knowledge_code set Knowledge_Code='"+value+"'where Knowledge_CodeID='"+id+"'";
...
//                   response.sendRedirect("CountyServlet");
                                ...
                                Logger.getLogger(UpdateEducation.class.getName()).log(Level.SEVERE, null, ex);
