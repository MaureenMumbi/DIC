...
session = request.getSession(true);
                                        ...
                                        String query = "select * from dicname";
        ...
        if(list2!=null && list2.size()>0 ){list2.clear();}
                       ...
                       DB.setDICID(conn.rs.getInt(1));
                       DB.setDICNAME(conn.rs.getString(2));
                       DB.setDISTRICTID(conn.rs.getInt(3));
                      
          
                       list2.add(DB);
                       System.out.println(DB.getDICID());  
                      System.out.println(DB.getDICNAME());  
                      
        }
       session.setAttribute("list2", list2);
                                 String nextJSP = "/Maintenance/DIC.jsp";
