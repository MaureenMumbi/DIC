...
public class AddName extends HttpServlet {
    ...
    String query = "update enrollment set Firstname='"+FirstName+"', SecondName='"+SecondName+"', LastName='"+LastName+"' where UniqueID='"+UniqueID+"'";
    System.out.println("qugefgefgdhscvsdhbcvxbnmv zxbn"+query);
 try {
