 ...
 * @author Maureen
 */
public class UpdateCSCode extends HttpServlet {
...
//  String unique=(String)session.getAttribute("countyid");
	...
	String query = "update cscode set CSCode='"+value+"'where CSCodeID='"+id+"'";
...
//                   response.sendRedirect("CountyServlet");
                                ...
                                Logger.getLogger(UpdateCSCode.class.getName()).log(Level.SEVERE, null, ex);
